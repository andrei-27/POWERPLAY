...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 15.37; // in; distance between the left and right wheels 9.3 - 13.575 // 14.4
    public static double FORWARD_OFFSET = -6.88; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.0124; // Multiplier in the X direction
